...
namespace Fizjobackend.Migrations
{
    ...
    [Migration("20241126165951_AppointmentTreatments")]
    partial class AppointmentTreatments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fizjobackend.Entities.PhysiotherapistEntities.PhysiotherapySpecializationEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("73bf716c-7da5-4100-a1c4-d63ec74eb53c"),
                            PhysiotherapySpecialization = "Orthopedic"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("462f2336-9b7e-4d74-85b1-f4a66d25cef5"),
                            PhysiotherapySpecialization = "Neurological"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("bbc10bda-d543-4b03-9259-71ecf25a3232"),
                            PhysiotherapySpecialization = "Pediatric"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("2df6e858-4983-4fd3-b6e0-3e160c4014ba"),
                            PhysiotherapySpecialization = "CardiovascularAndPulmonary"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("0223adad-d8cc-4f7e-adfe-e6470840e227"),
                            PhysiotherapySpecialization = "Geriatric"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("fca23d9f-b18a-426f-b3f7-61a6b4115316"),
                            PhysiotherapySpecialization = "Sports"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("76fb0d1a-cd78-4f45-ad96-35e340884ff7"),
                            PhysiotherapySpecialization = "Urogynecological"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("3bc10cec-9405-45ac-89d0-29c259247b60"),
                            PhysiotherapySpecialization = "Oncological"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("d54880b2-8c2b-4f38-9abf-b450d77f2fe0"),
                            PhysiotherapySpecialization = "Dental"
                        },
                        new
                        {
                            PhysiotherapySpecializationId = new Guid("7524500f-89c1-4f5b-862a-cc76ae3690d7"),
