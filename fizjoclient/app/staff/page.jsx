  ...
  const fetchSpecialists = async () => {
    try {
      const params = {
        ...
        ...(debouncedAveragePrice !== null
          ? { averagePrice: debouncedAveragePrice }
          : {}),
      };
      ...
      {!recommendStaff && (
        <div className={styles.searchContainer}>
          ...
          <div className={styles.sliderContainer}>
            <label>
              {t.averagePrice}: {averagePrice !== null ? averagePrice : t.any}{" "}
              pln
            </label>
            <input
              type="range"
        ...
        {specialists.length > 0 ? (
          specialists.map((specialist) => (
            <div
              ...
              onClick={() =>
                handleSelectSpecialist(specialist.physiotherapistId)
              }
            >
              ...
              <p className={styles.specialistInfo}>
                {t.specialists[specialist.specialization]}
              </p>
              ...
              <p className={styles.specialistExperience}>
                {specialist.experience} {t.experience}
              </p>
            </div>
          ))
        ) : (
