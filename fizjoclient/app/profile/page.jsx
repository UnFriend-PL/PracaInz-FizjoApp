                    ...
                    {workingHours.length > 0 ? (
                        <ul className={styles.workingHoursList}>
                            {workingHours.map((hour) => (
                                <li key={hour.id} className={styles.workingHourItem}>
                                    <span className={styles.dayOfWeek}>{t[`day${hour.dayOfWeek}`]}</span>
                        ...
                        <div className={styles.noWorkingHours}>{t.noWorkingHours}</div>
                    )}
                </div>
